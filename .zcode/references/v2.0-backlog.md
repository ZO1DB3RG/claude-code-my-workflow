...
- ✅ **Stata expansion** — `/stata-replication` + `.zcode/rules/stata-code-conventions.md` + `/audit-reproducibility` Stata coverage shipped (Pass 4). Was not originally on the v1.9 backlog but added per user request mid-cycle.
